...
Packages with other changes:
 ...
 - [`native_toolchain_rust` - `v0.1.0-dev.8`](#native_toolchain_rust---v010-dev6)

---

#### `native_toolchain_rust` - `v0.1.0-dev.8`

 - **FEAT**: support custom library name for crates with a dash/hyphen (`-`) in its package name by vhdirk.
